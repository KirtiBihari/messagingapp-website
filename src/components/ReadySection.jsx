      ...
      <div className="container-narrow">
        <div className="rounded-[2rem] bg-brand-950 p-10 text-white">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-accent-100 mb-6">Tell us your volumes, use case and compliance needs. We'll provision SMS and Voice for you and add you to the WhatsApp early access list.</p>
