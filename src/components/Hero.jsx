  ...
  return (
    <section className="bg-slate-50">
      <div className="container-narrow pt-20 pb-12">
        <span className="chip">Designed in India, Connecting Bharat.</span>
        ...
        <p className="mt-6 max-w-2xl text-lg text-brand-600">
          MessagingApp is the single place to send SMS, Voice and soon WhatsApp to customers across India. One API, one dashboard, one wallet.
        </p>
